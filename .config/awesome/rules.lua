...
function rules.create(clientkeys, clientbuttons)
   ...
   return {
      ...
      -- },
      -- Set VsCode to always map on the tag named "4" on screen 1.
      {
         rule = { class = "Code" },
         properties = { screen = 1, tag = "4", switchtotag = true }
      },
      -- Set Firefox to always map on the tag named "5" on screen 1.
      {
         rule = { class = "Firefox" },
         properties = { screen = 1, tag = "5", switchtotag = true }
      },
      -- Set Thunar to always map on the tag named "5" on screen 1.
      {
         rule = { class = "Thunar" },
